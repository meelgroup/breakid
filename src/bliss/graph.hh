...
class Graph : public AbstractGraph
{
   ...
   */
    ...
    bool refine_according_to_invariant(
   ...
   protected:
    class Vertex
    {
       public:
        ...
        unsigned int nof_edges_in() const
        {
            return edges_in.size();
        }
        unsigned int nof_edges_out() const
        {
